...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('climbs_area', (
            ...
            ('approach_time', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('approach_distance', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('lot_parking', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('street_parking', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('garage_parking', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('pullout_parking', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('nearest_emergency_phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True, blank=True)),
