...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for area in orm.Area.objects.all():
            if area.parking_type:
                parking = orm.Parking(parking_type=area.parking_type,
                                      description=area.parking_description,
                                      latitude=area.parking_latitude, 
                                      longitude=area.parking_longitude)
                parking.save()
                parking.area.add(area)
