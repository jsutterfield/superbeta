...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Area.parking_gps'
        db.delete_column('climbs_area', 'parking_gps')

        # Deleting field 'Area.approach_gps'
        db.delete_column('climbs_area', 'approach_gps')

        # Adding field 'Area.parking_gps_long'
        db.add_column('climbs_area', 'parking_gps_long',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6, blank=True),
                      keep_default=False)

        # Adding field 'Area.parking_gps_lat'
        db.add_column('climbs_area', 'parking_gps_lat',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6, blank=True),
                      keep_default=False)

        # Adding field 'Area.approach_gps_long'
        db.add_column('climbs_area', 'approach_gps_long',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6, blank=True),
                      keep_default=False)

        # Adding field 'Area.approach_gps_lat'
        db.add_column('climbs_area', 'approach_gps_lat',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Area.parking_gps'
        db.add_column('climbs_area', 'parking_gps',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6, blank=True),
                      keep_default=False)

        # Adding field 'Area.approach_gps'
        db.add_column('climbs_area', 'approach_gps',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6, blank=True),
                      keep_default=False)

        # Deleting field 'Area.parking_gps_long'
        db.delete_column('climbs_area', 'parking_gps_long')

        # Deleting field 'Area.parking_gps_lat'
        db.delete_column('climbs_area', 'parking_gps_lat')

        # Deleting field 'Area.approach_gps_long'
        db.delete_column('climbs_area', 'approach_gps_long')

        # Deleting field 'Area.approach_gps_lat'
        db.delete_column('climbs_area', 'approach_gps_lat')
