...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Area.nearest_emergttency_two_address'
        db.delete_column('climbs_area', 'nearest_emergttency_two_address')


    def backwards(self, orm):
        # Adding field 'Area.nearest_emergttency_two_address'
        db.add_column('climbs_area', 'nearest_emergttency_two_address',
