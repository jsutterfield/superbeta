...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Area.spring'
        db.add_column('climbs_area', 'spring',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Area.summer'
        db.add_column('climbs_area', 'summer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Area.fall'
        db.add_column('climbs_area', 'fall',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Area.spring'
        db.delete_column('climbs_area', 'spring')

        # Deleting field 'Area.summer'
        db.delete_column('climbs_area', 'summer')

        # Deleting field 'Area.fall'
        db.delete_column('climbs_area', 'fall')
    ...
    models = {
        'climbs.area': {
            ...
            'word': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
