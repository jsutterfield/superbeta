...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Area.lot_parking'
        db.add_column('climbs_area', 'lot_parking',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Area.street_parking'
        db.add_column('climbs_area', 'street_parking',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Area.garage_parking'
        db.add_column('climbs_area', 'garage_parking',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Area.pullout_parking'
        db.add_column('climbs_area', 'pullout_parking',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Area.lot_parking'
        db.delete_column('climbs_area', 'lot_parking')

        # Deleting field 'Area.street_parking'
        db.delete_column('climbs_area', 'street_parking')

        # Deleting field 'Area.garage_parking'
        db.delete_column('climbs_area', 'garage_parking')

        # Deleting field 'Area.pullout_parking'
        db.delete_column('climbs_area', 'pullout_parking')
