...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Route', fields ['slug']
        db.delete_unique('climbs_route', ['slug'])


        # Changing field 'Route.slug'
        db.alter_column('climbs_route', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=('area__name',), max_length=50, populate_from='name'))

    def backwards(self, orm):

        # Changing field 'Route.slug'
        db.alter_column('climbs_route', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
        # Adding unique constraint on 'Route', fields ['slug']
        db.create_unique('climbs_route', ['slug'])
