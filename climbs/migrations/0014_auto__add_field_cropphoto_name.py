...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CropPhoto.name'
        db.add_column('climbs_cropphoto', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Shamus', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CropPhoto.name'
        db.delete_column('climbs_cropphoto', 'name')
    ...
    models = {
        'climbs.area': {
            ...
            'closest_city': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
